...
INSERT INTO restaurants (name, description, address, phone, email, cuisine_type, rating, delivery_time, minimum_order, delivery_fee, is_active, owner_id, image_url, created_at, updated_at)
VALUES 
-- Restaurant 1: Italian
('Bella Italia', 'Authentic Italian cuisine with fresh pasta and wood-fired pizzas', '123 Main Street, Downtown', '+1234567910', 'contact@bellaitalia.com', 'Italian', 4.5, 30, 15.00, 3.99, true, @owner_id, 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=800', NOW(), NOW()),

-- Restaurant 2: Mexican
('El Mariachi', 'Traditional Mexican flavors with a modern twist', '456 Oak Avenue, Midtown', '+1234567911', 'info@elmariachi.com', 'Mexican', 4.7, 25, 12.00, 2.99, true, @owner_id, 'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=800', NOW(), NOW()),

-- Restaurant 3: Chinese
('Golden Dragon', 'Exquisite Chinese dishes from various regions', '789 Pine Road, Eastside', '+1234567912', 'hello@goldendragon.com', 'Chinese', 4.6, 35, 20.00, 4.99, true, @owner_id, 'https://images.unsplash.com/photo-1526318896980-cf78c088247c?w=800', NOW(), NOW()),

-- Restaurant 4: American
('The Burger Joint', 'Gourmet burgers and classic American comfort food', '321 Elm Street, Westside', '+1234567913', 'orders@burgerjoint.com', 'American', 4.4, 20, 10.00, 2.49, true, @owner_id, 'https://images.unsplash.com/photo-1550547660-d9450f859349?w=800', NOW(), NOW()),

-- Restaurant 5: Middle Eastern
('Sahara Nights', 'Authentic Middle Eastern cuisine and mezze', '654 Cedar Lane, Northside', '+1234567914', 'contact@saharanights.com', 'Middle Eastern', 4.8, 28, 18.00, 3.49, true, @owner_id, 'https://images.unsplash.com/photo-1529006557810-274b9b2fc783?w=800', NOW(), NOW()),

-- Restaurant 6: Japanese
('Sakura Sushi', 'Fresh sushi and traditional Japanese dishes', '987 Maple Drive, Central', '+1234567915', 'info@sakurasushi.com', 'Japanese', 4.9, 40, 25.00, 5.99, true, @owner_id, 'https://images.unsplash.com/photo-1579584425555-c3ce17fd4351?w=800', NOW(), NOW()),

-- Restaurant 7: Indian
('Spice Garden', 'Aromatic Indian curries and tandoori specialties', '147 Birch Street, Southside', '+1234567916', 'hello@spicegarden.com', 'Indian', 4.5, 32, 16.00, 3.99, true, @owner_id, 'https://images.unsplash.com/photo-1585937421612-70a008356fbe?w=800', NOW(), NOW()),

-- Restaurant 8: Thai
('Bangkok Street', 'Authentic Thai street food and curries', '258 Willow Avenue, Downtown', '+1234567917', 'orders@bangkokstreet.com', 'Thai', 4.6, 27, 14.00, 2.99, true, @owner_id, 'https://images.unsplash.com/photo-1559314809-0d155014e29e?w=800', NOW(), NOW()),

-- Restaurant 9: Mediterranean
('Olive Grove', 'Fresh Mediterranean dishes with Greek influences', '369 Spruce Road, Midtown', '+1234567918', 'contact@olivegrove.com', 'Mediterranean', 4.7, 30, 17.00, 3.49, true, @owner_id, 'https://images.unsplash.com/photo-1544025162-d76694265947?w=800', NOW(), NOW()),

-- Restaurant 10: French
('Le Petit Bistro', 'Classic French cuisine in an intimate setting', '741 Ash Lane, Eastside', '+1234567919', 'info@lepetitbistro.com', 'French', 4.8, 45, 30.00, 4.99, true, @owner_id, 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=800', NOW(), NOW()),

-- Restaurant 11: Korean
('Seoul Kitchen', 'Modern Korean BBQ and traditional dishes', '852 Bamboo Street, Westside', '+1234567920', 'contact@seoulkitchen.com', 'Korean', 4.7, 33, 19.00, 3.99, true, @owner_id, 'https://images.unsplash.com/photo-1580554530778-ca36943938b2?w=800', NOW(), NOW()),

-- Restaurant 12: Vietnamese
('Pho Paradise', 'Authentic Vietnamese pho and banh mi', '963 Lotus Avenue, Northside', '+1234567921', 'info@phoparadise.com', 'Vietnamese', 4.6, 26, 13.00, 2.49, true, @owner_id, 'https://images.unsplash.com/photo-1582878826629-29b7ad1cdc43?w=800', NOW(), NOW()),

-- Restaurant 13: Spanish
('Tapas Barcelona', 'Spanish tapas and paella specialties', '159 Olive Street, Central', '+1234567922', 'hello@tapasbarcelona.com', 'Spanish', 4.8, 35, 22.00, 4.49, true, @owner_id, 'https://images.unsplash.com/photo-1534080564583-6be75777b70a?w=800', NOW(), NOW()),

-- Restaurant 14: Brazilian
('Rio Grill', 'Brazilian churrasco and traditional dishes', '357 Palm Avenue, Southside', '+1234567923', 'orders@riogrill.com', 'Brazilian', 4.5, 38, 24.00, 4.99, true, @owner_id, 'https://images.unsplash.com/photo-1529692236671-f1f6cf9683ba?w=800', NOW(), NOW()),

-- Restaurant 15: Caribbean
('Island Spice', 'Caribbean jerk chicken and tropical flavors', '486 Coconut Lane, Downtown', '+1234567924', 'contact@islandspice.com', 'Caribbean', 4.6, 29, 15.00, 3.49, true, @owner_id, 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=800', NOW(), NOW());
