        ...
        <Card className="p-6 mb-6">
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                <option className="bg-card" value="ALL">All Roles</option>
                <option className="bg-card" value="CUSTOMER">Customers</option>
                <option className="bg-card" value="RESTAURANT_OWNER">Restaurant Owners</option>
                <option className="bg-card" value="DELIVERY_AGENT">Delivery Agents</option>
                <option className="bg-card" value="ADMIN">Admins</option>
              </select>
            </div>
          </div>
                ...
                {filteredUsers.length === 0 ? (
                  <tr>
                    <td colSpan="5" className="px-6 py-12 text-center text-muted-foreground">
                      <Users className="w-12 h-12 mx-auto mb-2 text-muted-foreground/40" />
                      <p>No users found</p>
                    </td>
                  </tr>
                ) : (
