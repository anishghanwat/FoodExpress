    ...
    <div className="min-h-screen bg-[#0f0f0f]">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-white/60">Manage all platform restaurants</p>
        </div>

        {/* Stats Cards */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <Card className="p-4">
            <p className="text-sm text-white/60 mb-1">Total Restaurants</p>
          ...
          <Card className="p-4">
            <p className="text-sm text-white/60 mb-1">Inactive</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredRestaurants.length === 0 ? (
            <Card className="col-span-full p-12 text-center">
              <Store className="w-12 h-12 mx-auto mb-2 text-white/20" />
              <p className="text-white/60">No restaurants found</p>
            </Card>
          ) : (
              ...
              <Card key={restaurant.id} className="p-6">
                <div className="flex justify-between items-start mb-4">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-white/60 mb-2">{restaurant.address}</p>
                    {restaurant.phone && (
                      <p className="text-xs text-white/40">{restaurant.phone}</p>
                    )}
                  </div>
                  {restaurant.isActive ? (
